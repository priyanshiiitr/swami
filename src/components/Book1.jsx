                ...
                <motion.div variants={itemVariants} className="flex justify-center mb-8">
                    <span className="inline-flex items-center gap-2 px-8 py-2 rounded-full border border-orange-300 text-orange-500 font-medium bg-white/50 backdrop-blur-sm shadow-sm">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                            ...
                            <path d="M13.333 1.33333V3.99999" stroke="#FF5900" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M14.6667 2.66667H12" stroke="#FF5900" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M2.66634 14.6667C3.40272 14.6667 3.99967 14.0697 3.99967 13.3333C3.99967 12.597 3.40272 12 2.66634 12C1.92996 12 1.33301 12.597 1.33301 13.3333C1.33301 14.0697 1.92996 14.6667 2.66634 14.6667Z" stroke="#FF5900" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
